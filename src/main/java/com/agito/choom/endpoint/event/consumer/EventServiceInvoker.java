package com.agito.choom.endpoint.event.consumer;

import com.agito.choom.PojaGenerated;
import com.agito.choom.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.agito.choom.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.agito.choom.service.event."
