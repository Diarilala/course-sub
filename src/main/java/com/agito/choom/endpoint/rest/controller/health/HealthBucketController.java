package com.agito.choom.endpoint.rest.controller.health;

import static com.agito.choom.file.hash.FileHashAlgorithm.NONE;
...
import com.agito.choom.file.hash.FileHash;
import java.io.File;
